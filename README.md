About approxposterior-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/approxposterior-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/dflemin3/approxposterior

Documentation: https://dflemin3.github.io/approxposterior/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2702&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/approxposterior-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `approxposterior` can be installed with `conda`:
...
```
mamba install approxposterior
```

It is possible to list all of the versions of `approxposterior` available on your platform with `conda`:
...
```
mamba search approxposterior --channel conda-forge
```
...
mamba repoquery search approxposterior --channel conda-forge

# List packages depending on `approxposterior`:
mamba repoquery whoneeds approxposterior --channel conda-forge

# List dependencies of `approxposterior`:
mamba repoquery depends approxposterior --channel conda-forge
```
